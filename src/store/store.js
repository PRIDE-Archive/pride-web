...
export default new Vuex.Store({
	state:{
		...
		baseApiURL: process.env.API_USE.match(/production/) ? 'https://www.ebi.ac.uk/pride/ws/archive/v2':'https://wwwdev.ebi.ac.uk/pride/ws/archive/v2',
		basePrivateURL: process.env.API_USE.match(/production/) ? 'https://www.ebi.ac.uk/pride/private/ws/archive/v2':'https://wwwdev.ebi.ac.uk/pride/ws/archive/v2',
		username: '',
		token:''
