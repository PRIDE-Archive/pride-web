...
export default new Vuex.Store({
	state:{
		...
		basePrivateURL: process.env.NODE_ENV.match(/production|prod-api/) ? 'http://www.ebi.ac.uk/pride/ws/archive/private/v2':'http://www.ebi.ac.uk/pride/ws/archive/private/v2',  
		username: '',
		token:''
